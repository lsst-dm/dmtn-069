...
fluctuations, at a fiducial seeing of 0.6''.  This indicates that,
when compared to zenith templates, $i$--band images at airmass
1.1--1.4 will start to show significant dipoles due to DCR (in 0.6''
seeing).  This effect will be more pronounced for the bluer passbands.
At reference airmass 1.25, orientation differences of 15 degrees in
the $r$--band, and 25 degrees in $i$--band, will lead to a similar
increase in dipole rate.  In the $u$ and $g$--bands, all examined
...
respectively, corresponding to DCR shifts of 0.0006 and 0.001 mas.
These results are shown in Figure~\ref{fig:fpregress2}.
...
constant offset at 1 and 2mas.  The top panel shows these results for
a template at airmass 1.0, which has no DCR in any passband.  Thus
observations at {\it all} orientations yield similar results, and
there is only a rate dependence on airmass difference.  On the top
left we show these results for the $r$--band, where the amplitudes are
all larger than 2mas and thus no contours displayed.  On the top
right we show the same plots for $i$--band.  We find that airmass 1.1
science images will have relative DCR offsets of 1mas in the blue
stars, and airmass 1.4 images will have relative offsets of 2mas.  For
the red stars, which have higher overall DCR amplitudes in this study,
all data have relative offsets larger than 2mas.  The bottom panels
show these same results for airmass 1.25 templates, and demonstrate
the interaction between airmass and orientation difference.  For data
taken at the same airmass, orientation differences of 15 degrees will
yield to enhanced dipole rate in $r$--band (lower left), and 25
degrees in $i$--band (lower right), driven by the red stars.  At the
same DCR orientation, airmass differences of approximately 0.1 in
$r$--band and 0.15 in $i$--band will yield the same enhanced rate of
false positives.  We note that at the coarseness of this study (steps
of 0.1 in airmass and 5 degrees in orientation), {\it all} $g$--band
data will show enhanced dipole rates.  This will be seen to a larger
degree in the $u$--band, although the faintness of the redder stars
may mean that there will be fewer red objects in the images, and
accordingly a bluer astrometric reference frame used.
...
\begin{figure}[!ht]
  \centering
  \subfloat[$r$--band, 1.0 airmass template]{{\includegraphics[width=0.46\textwidth]{\figdir/ampRedo3B.png} }}
  \qquad
  \subfloat[$i$--band, 1.0 airmass template]{{\includegraphics[width=0.46\textwidth]{\figdir/ampRedo3A.png} }} \\
  \subfloat[$r$--band, 1.25 airmass template]{{\includegraphics[width=0.46\textwidth]{\figdir/ampRedo3D.png} }}
  \qquad
  \subfloat[$i$--band, 1.25 airmass template]{{\includegraphics[width=0.46\textwidth]{\figdir/ampRedo3C.png} }} \\
  \caption{{\bf DCR Offsets vs. Airmass and Orientation}: Each of
    ...
    panels, 1.25 bottom panels) and spectral type ({\tt A0V} star top
    ...
    plotted at 1 mas in blue and 2 mas in red, corresponding to the
    approximate offsets where DCR starts to dominate the the false
    positive rate (Figure~\ref{fig:fpregress}) at a fiducial seeing of
    0.6''.  We note that the top panels, with the reference observation
    at airmass 1.0, have no orientation dependence of this value
    because there is no DCR in the reference observation.
%
...
\item This indicates that most/all data taken in the $u$--band and
  $g$--bands will be highly sensitive to this DCR effect.

\item Assuming airmass 1.0 templates, all $r$--band data (within the
  coarseness of this study) will yield significant DCR dipoles.
  Templates in $i$--band from airmass 1.0 should not be used to
  difference against science images at larger than 1.1--1.4 airmass

\item Assuming airmass 1.25 templates, science images at the same
  airmass but having orientation differences of (15; 25) degrees
  ($r$--band; $i$--band) will yield the same rate of dipoles.
  Assuming the same parallactic angle orientation, airmass differences
  of (0.1, 0.15) respectively will yield the same results.
