...
\begin{figure}[!ht]
  \centering
  \subfloat[$g$--band, 1.0 airmass template]{{\includegraphics[width=0.29\textwidth]{\figdir/dcrG1.png} }}
  \qquad
  \subfloat[$r$--band, 1.0 airmass template]{{\includegraphics[width=0.29\textwidth]{\figdir/dcrR1.png} }} 
  \qquad
  \subfloat[$i$--band, 1.0 airmass template]{{\includegraphics[width=0.29\textwidth]{\figdir/dcrI1.png} }} \\
  \subfloat[$g$--band, 1.25 airmass template]{{\includegraphics[width=0.29\textwidth]{\figdir/dcrG125.png} }}
  \qquad
  \subfloat[$r$--band, 1.25 airmass template]{{\includegraphics[width=0.29\textwidth]{\figdir/dcrR125.png} }} 
  \qquad
  \subfloat[$i$--band, 1.25 airmass template]{{\includegraphics[width=0.29\textwidth]{\figdir/dcrI125.png} }} \\
